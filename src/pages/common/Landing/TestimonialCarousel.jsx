...
//       id: 1,
//       name: 'Hary Komnba',
//       position: 'Owner, Herimediacraft Store',
...
//           </div>
//           <div className="text-center">
//             <p className="text-4xl font-bold text-primary mb-2">Tzs2.5M+</p>
...
const TestimonialCarousel = () => {
  ...
  return (
    <section className="py-16 bg-gray-50 dark:bg-black overflow-hidden" id='testimonials'>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
            Trusted by Businesses <span className="text-primary dark:text-primary">Like Yours</span>
          </h2>
        ...
        <div className="relative">
            ...
            >
              {testimonials.map((testimonial) => (
                <div 
                  ...
                  className="w-full flex-shrink-0 px-4"
                >
                  <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-transparent dark:border-gray-700 p-8 md:p-10 relative z-10 h-full">
                    <div className="flex flex-col md:flex-row gap-8 h-full">
                      {/* Left Column - Image and Info */}
                      <div className="md:w-1/3 flex flex-col items-center md:items-start">
                        <div className="relative mb-4">
                          <div className="w-24 h-24 rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-primary/10"></div>
                            <div className="absolute inset-0 flex items-center justify-center text-2xl font-bold text-primary">
                              {testimonial.name.charAt(0)}
                            </div>
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center md:text-left">{testimonial.name}</h3>
                        <p className="text-gray-600 dark:text-gray-400 mb-4 text-center md:text-left">{testimonial.position}</p>
                        ...
                        <div className="space-y-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
                          <div className="flex items-center space-x-2">
                            <span className="font-medium dark:text-gray-300">Business:</span>
                            <span>{testimonial.businessType}</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <span className="font-medium dark:text-gray-300">Team Size:</span>
                            <span>{testimonial.employeeCount} employees</span>
                          </div>
                          <div className="flex items-center space-x-2">
                            <span className="font-medium dark:text-gray-300">Using for:</span>
                            <span>{testimonial.yearsSince} {testimonial.yearsSince === 1 ? 'year' : 'years'}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Right Column - Content */}
                      <div className="md:w-2/3 flex flex-col justify-center">
                        <div className="text-lg md:text-xl text-gray-700 dark:text-gray-300 italic mb-6 relative">
                          <p>"{testimonial.content}"</p>
                        </div>
                        
                        <div className="mt-auto">
                          <Button variant="outline" size="sm" className="text-primary hover:text-primary-dark dark:border-gray-600 dark:text-primary dark:hover:bg-gray-700">
                            Read Full Story
                          </Button>
                        </div>
                      </div>
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${activeIndex === index ? 'bg-primary w-8' : 'bg-gray-300 dark:bg-gray-600'}`}
                aria-label={`Go to testimonial ${index + 1}`}
              />
            ))}
          </div>
          ...
          <button
            onClick={prevTestimonial}
            className="absolute top-1/2 -translate-y-1/2 -left-4 md:left-0 w-10 h-10 bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700 rounded-full shadow-lg flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors z-20"
            aria-label="Previous testimonial"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={nextTestimonial}
            className="absolute top-1/2 -translate-y-1/2 -right-4 md:right-0 w-10 h-10 bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700 rounded-full shadow-lg flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors z-20"
            aria-label="Next testimonial"
          >
            <ChevronRight className="w-6 h-6" />
          </button>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            <p className="text-4xl font-bold text-primary dark:text-primary mb-2">500+</p>
            <p className="text-gray-600 dark:text-gray-400">Happy Customers</p>
          </div>
          <div className="text-center">
            <p className="text-4xl font-bold text-primary dark:text-primary mb-2">98%</p>
            <p className="text-gray-600 dark:text-gray-400">Customer Satisfaction</p>
          </div>
          <div className="text-center">
            <p className="text-4xl font-bold text-primary dark:text-primary mb-2">Tzs2.5M+</p>
            <p className="text-gray-600 dark:text-gray-400">Revenue Processed</p>
          </div>
          <div className="text-center">
            <p className="text-4xl font-bold text-primary dark:text-primary mb-2">24/7</p>
