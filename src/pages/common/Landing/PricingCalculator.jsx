        ...
        <div className="dark:text-white rounded-xl p-6 mt-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="text-right">
              <div className="text-3xl font-bold text-primary">Tzs{totalPrice.toLocaleString()}</div>
              {savings > 0 && (
                <div className="text-sm text-green-600">You save Tzs{savings.toLocaleString()}</div>
              )}
            </div>
          </div>
