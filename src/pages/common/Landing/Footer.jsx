...
import { Facebook, Twitter, Instagram, Linkedin, Youtube, Mail, ArrowRight, LocateIcon, Phone } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="bg-card dark:bg-black text-card-foreground border-t">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-foreground font-bold text-xl">PesaFlow</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">support@pesaflow.com</span>
              </li>
              <li className="flex  items-start text-muted-foreground">
                <LocateIcon className='h-5 w-5 mr-2 mt-0.5 text-muted-foreground'/>
                <div>
                  <p>Arusha, Tanzania</p>
                </div>
              </li>
