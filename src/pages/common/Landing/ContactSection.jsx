              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">+255 6 273 843 28</p>
                    <p className="opacity-90">+255 7 671 671 78</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">sales@pesaflow.com</p>
                    <p className="opacity-90">support@pesaflow.com</p>
                  </div>
                </div>
