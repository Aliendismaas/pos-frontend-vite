            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    {selectedTransaction.totalAmount > 0
                      ? `+Tsh ${selectedTransaction.totalAmount.toFixed(0)}`
                      : `-Tsh ${Math.abs(selectedTransaction.totalAmount).toFixed(0)}`}
                  </p>
                </div>
              </div>
