      ...
      <div className="bg-white p-6 max-h-96 overflow-y-auto">
            ...
            {selectedOrder.items
              ...
              .map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="text-right py-2">Tzs{item.product?.sellingPrice?.toFixed(2)}</TableCell>
                  <TableCell className="text-right py-2">
                    Tzs{(item.product.sellingPrice * item.returnQuantity)?.toFixed(2)}
                  </TableCell>
                </TableRow>
              ))}
          </TableBody>
        ...
        <div className="space-y-1 text-sm mb-4">
          <div className="flex justify-between font-bold border-t pt-1">
            ...
            <span>Tzs{selectedOrder.totalAmount}</span>
          </div>
