        ...
        <div>
          ...
          <div className="text-sm">
            ...
            <div className="flex justify-between font-medium">
              ...
              <span>Tzs{selectedOrder.totalAmount?.toFixed(2)}</span>
            </div>
          </div>
        </div>
      </CardContent>
        ...
        <TableBody>
          {selectedOrder.items.map(item => (
            <TableRow key={item.id}>
              ...
              <TableCell className="text-right">Tzs{(item.product?.sellingPrice)?.toFixed(2)}</TableCell>
              <TableCell className="text-right">Tzs{(item.product?.sellingPrice * item.quantity).toFixed(2)}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
