    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <span className="text-2xl font-bold">Tzs{(customer.totalSpent || 0).toFixed(2)}</span>
          </CardContent>
        </Card>
      </div>
      ...
      {customer.averageOrderValue && (
        <Card>
          ...
          <CardContent>
            <span className="text-2xl font-bold">Tzs{customer.averageOrderValue.toFixed(2)}</span>
          </CardContent>
        </Card>
      )}
